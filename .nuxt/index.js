...
import nuxt_plugin_plugin_e7a00b4a from 'nuxt_plugin_plugin_e7a00b4a' // Source: ./components/plugin.js (mode: 'all')
import nuxt_plugin_index_3800bc8e from 'nuxt_plugin_index_3800bc8e' // Source: ./components/index.js (mode: 'all')
import nuxt_plugin_pluginutils_1b234f2c from 'nuxt_plugin_pluginutils_1b234f2c' // Source: ./nuxt-i18n/plugin.utils.js (mode: 'all')
import nuxt_plugin_pluginrouting_738b1996 from 'nuxt_plugin_pluginrouting_738b1996' // Source: ./nuxt-i18n/plugin.routing.js (mode: 'all')
import nuxt_plugin_pluginmain_3545674c from 'nuxt_plugin_pluginmain_3545674c' // Source: ./nuxt-i18n/plugin.main.js (mode: 'all')
import nuxt_plugin_pluginclient_9bb1bf52 from 'nuxt_plugin_pluginclient_9bb1bf52' // Source: ./content/plugin.client.js (mode: 'client')
import nuxt_plugin_pluginserver_17e091df from 'nuxt_plugin_pluginserver_17e091df' // Source: ./content/plugin.server.js (mode: 'server')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_e7a00b4a === 'function') {
    await nuxt_plugin_plugin_e7a00b4a(app.context, inject)
  }

  if (typeof nuxt_plugin_index_3800bc8e === 'function') {
    await nuxt_plugin_index_3800bc8e(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginutils_1b234f2c === 'function') {
    await nuxt_plugin_pluginutils_1b234f2c(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginrouting_738b1996 === 'function') {
    await nuxt_plugin_pluginrouting_738b1996(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginmain_3545674c === 'function') {
    await nuxt_plugin_pluginmain_3545674c(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_pluginclient_9bb1bf52 === 'function') {
    await nuxt_plugin_pluginclient_9bb1bf52(app.context, inject)
  }

  if (process.server && typeof nuxt_plugin_pluginserver_17e091df === 'function') {
    await nuxt_plugin_pluginserver_17e091df(app.context, inject)
  }
